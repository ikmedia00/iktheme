...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $post = Posts::create([
            ...
            'gambar'        => 'public/upload/gambar/' . $new_gambar,
        ...
        $gambar->move('public/upload/gambar/', $new_gambar);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('post.index')->with('success', 'Update postingan berhasil!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'Post berhasil dipindahkan ke "Trash Post"!');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->back()->with('success', 'Post berhasil ditampilkan kembali!');
    }
